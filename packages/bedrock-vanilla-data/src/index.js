...
exports.MinecraftData = exports.Vanilla = exports.Types = exports.MinecraftDataSet = exports.Edu = void 0;
...
Object.defineProperty(exports, "MinecraftDataSet", { enumerable: true, get: function () { return types_1.MinecraftDataSet; } });
...
(function (MinecraftData) {
    ...
    MinecraftData.vanilla = {
        BehaviorPack: {
            ...
            lootTables: lib_1.Vanilla.BehaviorPack.LootTables,
            trading: lib_1.Vanilla.BehaviorPack.Trading,
        },
        ResourcePack: {
            animationControllers: lib_1.Vanilla.ResourcePack.AnimationControllers,
            ...
            renderControllers: lib_1.Vanilla.ResourcePack.RenderControllers,
            sounds: lib_1.Vanilla.ResourcePack.Sounds,
            soundFiles: lib_1.Vanilla.ResourcePack.SoundFiles,
            textures: lib_1.Vanilla.ResourcePack.Textures,
            textureAtlasItems: lib_1.Vanilla.ResourcePack.TextureItems,
            textureAtlasTerrain: lib_1.Vanilla.ResourcePack.TextureTerrain,
        },
    };
    ...
    MinecraftData.edu = {
        BehaviorPack: {
            ...
            lootTables: lib_1.Edu.BehaviorPack.LootTables,
            trading: lib_1.Edu.BehaviorPack.Trading,
        },
        ResourcePack: {
            animationControllers: lib_1.Edu.ResourcePack.AnimationControllers,
            ...
            renderControllers: lib_1.Edu.ResourcePack.RenderControllers,
            sounds: lib_1.Edu.ResourcePack.Sounds,
            soundFiles: lib_1.Edu.ResourcePack.SoundFiles,
    ...
    (function (BehaviorPack) {
        ...
        function getLootTable(id, edu = false) {
            return getStr(id, edu, MinecraftData.vanilla.BehaviorPack.lootTables, MinecraftData.edu.BehaviorPack.lootTables);
        }
    ...
    (function (ResourcePack) {
        ...
        function getAnimationController(id, edu = false) {
            return get(id, edu, MinecraftData.vanilla.ResourcePack.animationControllers, MinecraftData.edu.ResourcePack.animationControllers);
        }
        ...
        function getRenderController(id, edu = false) {
            return getStr(id, edu, MinecraftData.vanilla.ResourcePack.renderControllers, MinecraftData.edu.ResourcePack.renderControllers);
        }
        ...
        function getSoundFile(file, edu = false) {
            return getStr(file, edu, MinecraftData.vanilla.ResourcePack.soundFiles, MinecraftData.edu.ResourcePack.soundFiles);
        }
