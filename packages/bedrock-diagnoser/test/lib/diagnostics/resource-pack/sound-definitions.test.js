...
describe("sound definitions", () => {
    const doc = {
        uri: path_1.default.join("resource_pack", "sounds", "sound_definitions.json"),
    ...
    test("Files with spaces in names should be matched correctly", () => {
        ...
        const diagnoser = diagnoser_1.TestDiagnoser.createDocument(undefined, docWithSpaces);
...
//# sourceMappingURL=sound-definitions.test.js.map