...
class InternalTest {
    ...
    constructor(projectData, files) {
        this.__projectData = new bc_minecraft_bedrock_project_2.MinecraftData(projectData ?? new bc_minecraft_bedrock_project_1.ProjectData(this));
        this.__files = files ?? new Map();
    }
    getDocument(uri) {
