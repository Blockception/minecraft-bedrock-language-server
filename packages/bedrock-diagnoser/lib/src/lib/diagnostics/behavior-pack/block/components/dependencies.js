...
exports.behaviorpack_block_components_dependencies = behaviorpack_block_components_dependencies;
...
function behaviorpack_block_components_dependencies(block, context, diagnoser) {
    (0, components_1.components_dependencies)("block", context, diagnoser, component_dependents_all, component_dependents_any);
}
