...
export interface JsonDocumentDiagnosticsBuilder<TDoc extends TextDocument = TextDocument, TContent = unknown> extends DocumentDiagnosticsBuilder<TDoc> {
    /**The parsed JSON content of the document*/
    parsedContent: TContent;
}
export declare namespace DocumentDiagnosticsBuilder {
    function wrap<T extends TextDocument = TextDocument>(diagnoser: DiagnosticsBuilder<T>, document: T): DocumentDiagnosticsBuilder<T>;
}
...
export declare namespace Metadata {
    function withMetadata<T extends object, M>(source: T, metadata: M): WithMetadata<T, M>;
}
//# sourceMappingURL=diagnostics-builder.d.ts.map