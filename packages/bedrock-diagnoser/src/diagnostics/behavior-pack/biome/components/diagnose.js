...
const component_test = {
    ...
    'minecraft:replace_biomes': (name, component, context, diagnoser) => {
        ...
        if (dimensions.size > 1 && typeof dimension == 'string')
            diagnoser.add(dimension, 'Using Biome Replacement for Overworld and Nether for the same Biome is discouraged but not prohibited', types_1.DiagnosticSeverity.warning, 'behaviorpack.biome.components.replace_biomes.multiple_dimensions');
    },
};
