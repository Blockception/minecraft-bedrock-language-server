...
const types_1 = require("bc-minecraft-bedrock-project/src/internal/types");
...
function check_min_engine_version(version, diagnoser) {
    ...
    if (version !== undefined) {
        if (bc_minecraft_bedrock_shared_1.Version.compare(version, { major: 1, minor: 8, patch: 0 }) >= 0)
            return;
    }
