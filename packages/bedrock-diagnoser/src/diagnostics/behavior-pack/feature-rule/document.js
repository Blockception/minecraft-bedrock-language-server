...
function diagnose_feature_rules_document(diagnoser) {
    ...
    (0, duplicate_check_1.no_other_duplicates)('behaviorpack.components', diagnoser.context.getProjectData().projectData.behaviorPacks.featuresRules, identifier, diagnoser);
    ...
    if ((0, diagnose_1.behaviorpack_feature_diagnose)(feature, diagnoser) && pass == 'pregeneration_pass') {
        ...
        if (type && !type.includes('carver'))
            diagnoser.add(feature, pass + ' is reserved for carver features', types_1.DiagnosticSeverity.error, 'behaviorpack.featuresRules.pregeneration_pass');
    }
