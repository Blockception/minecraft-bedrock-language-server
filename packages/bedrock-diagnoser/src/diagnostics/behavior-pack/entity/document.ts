...
import { lint_check_entity_naming, lint_check_identity_format, lint_check_namespace, lint_check_namespace_required } from '../../lint';
...
export function diagnose_entity_document(diag: DocumentDiagnosticsBuilder): void {
  ...
  lint_check_entity_naming(identifier, diagnoser);
