...
function diagnose_block_document(diagnoser) {
    ...
    block['minecraft:block']?.permutations?.forEach((p) => {
        ...
        (0, diagnose_1.behaviorpack_diagnose_block_components)(p, { ...context, isPermutation: true }, diagnoser);
    });
    ...
    const group = block['minecraft:block'].description.menu_category?.group;
