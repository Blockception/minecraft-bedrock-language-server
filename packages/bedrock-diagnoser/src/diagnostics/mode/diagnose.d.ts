...
export declare const mode_score_comparator_diagnose: ModeDiagnose;
...
export declare function mode_slotid_diagnose(value: OffsetWord, Com: Command | string, diagnoser: DiagnosticsBuilder): boolean;
export {};
