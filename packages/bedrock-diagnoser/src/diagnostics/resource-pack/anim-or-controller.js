...
function animation_reference_diagnose(value, diagnoser) {
    ...
    if (bc_minecraft_bedrock_vanilla_data_1.MinecraftData.vanilla.ResourcePack.animationControllers.some((anim) => anim.id === id)) {
        return;
    }
...
function is_animation_or_controller(id, diagnoser) {
    ...
    if (rp.animationControllers.has(id, diagnoser.project))
