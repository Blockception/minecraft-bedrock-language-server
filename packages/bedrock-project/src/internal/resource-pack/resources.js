...
function getUsingResources(receiver, source, document) {
    bc_minecraft_bedrock_shared_1.Definition.forEach(source.geometry, (reference) => {
    ...
    bc_minecraft_bedrock_shared_1.Definition.forEach(source.materials, (reference) => {
        receiver.assigned.add({
            scope: 'material',
            names: [reference],
            position: document.getText().indexOf(`"${reference}"`),
    ...
    bc_minecraft_bedrock_shared_1.Definition.forEach(source.textures, (reference) => {
        receiver.assigned.add({
            scope: 'texture',
            names: [reference],
            position: document.getText().indexOf(`"${reference}"`),
