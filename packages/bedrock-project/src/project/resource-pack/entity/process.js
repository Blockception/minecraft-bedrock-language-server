...
function process(doc) {
    ...
    const out = {
        ...
        animations: references_1.References.wrap(description.animation_controllers
    ...
    //process animations
    bc_minecraft_bedrock_shared_1.Definition.forEach(description.animations, (reference, id) => {
