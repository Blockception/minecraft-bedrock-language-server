...
/** */
class ResourcePack {
    type = pack_type_1.PackType.resource_pack;
    folder;
    context;
    manifest;
    ...
    constructor(folder, Context, manifest) {
        ...
        this.blockCullingRules = new types_1.DataSet();
        ...
        this.renderControllers = new types_1.DataSet();
        ...
        this.uiElements = new types_1.DataSet();
    }
    /**
     *
     * @param doc
    ...
    process(doc) {
        ...
        switch (Type) {
            ...
            case file_type_1.FileType.blockCullingRules:
    ...
    find(predicate) {
        let value;
        if ((value = this.animationControllers.find(predicate)))
            return value;
        if ((value = this.animations.find(predicate)))
            return value;
        if ((value = this.attachables.find(predicate)))
            return value;
        if ((value = this.blockCullingRules.find(predicate)))
            return value;
        ...
        if ((value = this.particles.find(predicate)))
            return value;
        if ((value = this.renderControllers.find(predicate)))
            return value;
        ...
        if ((value = this.textures.find(predicate)))
            return value;
        if ((value = this.uiElements.find(predicate)))
            return value;
        return value;
    }
    /**
    ...
    function is(value) {
        if (typeof value === 'object') {
            ...
            if (typeof temp.particles !== 'object')
                return false;
            if (typeof temp.renderControllers !== 'object')
                return false;
            ...
            if (typeof temp.animations !== 'object')
                return false;
            if (typeof temp.animationControllers !== 'object')
                return false;
            if (typeof temp.blockCullingRules !== 'object')
                return false;
