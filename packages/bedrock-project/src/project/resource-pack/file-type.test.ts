...
describe('RP Filetype', () => {
  describe('Detect', () => {
    const DetectTests = [
      ...
      { file: 'F:\\Example\\entity\\pig.json', type: FileType.entity },
      { file: 'F:\\Example\\manifest.json', type: FileType.manifest },
      { file: 'F:\\Example\\models\\entities\\pig.json', type: FileType.model },
      { file: 'F:\\Example\\models\\entity\\pig.json', type: FileType.model },
      { file: 'F:\\Example\\models\\pig.json', type: FileType.model },
      { file: 'F:\\Example\\particles\\example.json', type: FileType.particle },
      { file: 'F:\\Example\\render_controllers\\example.json', type: FileType.render_controller },
