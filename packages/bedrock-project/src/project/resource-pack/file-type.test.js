...
describe('RP Filetype', () => {
    describe('Detect', () => {
        const DetectTests = [
            ...
            { file: 'F:\\Example-rp\\models\\enity\\foo\\pig.geo.json', type: file_type_1.FileType.model },
            { file: 'F:\\Example-rp\\models\\enity\\pig.geo.json', type: file_type_1.FileType.model },
            { file: 'F:\\Example-rp\\models\\entities\\foo\\pig.geo.json', type: file_type_1.FileType.model },
            ...
            { file: 'F:\\Example-rp\\ui\\hud_screen.json', type: file_type_1.FileType.ui },
            { file: 'F:\\Example\\animation_controllers\\example.json', type: file_type_1.FileType.animation_controller },
            { file: 'F:\\Example\\animations\\example.json', type: file_type_1.FileType.animation },
            ...
            { file: 'F:\\Example\\entity\\pig.json', type: file_type_1.FileType.entity },
            { file: 'F:\\Example\\manifest.json', type: file_type_1.FileType.manifest },
            { file: 'F:\\Example\\models\\entities\\pig.json', type: file_type_1.FileType.model },
            { file: 'F:\\Example\\models\\entity\\pig.json', type: file_type_1.FileType.model },
            { file: 'F:\\Example\\models\\pig.json', type: file_type_1.FileType.model },
            { file: 'F:\\Example\\particles\\example.json', type: file_type_1.FileType.particle },
            { file: 'F:\\Example\\render_controllers\\example.json', type: file_type_1.FileType.render_controller },
            ...
            { file: 'F:\\Example\\ui\\hud_screen.json', type: file_type_1.FileType.ui },
        ];
