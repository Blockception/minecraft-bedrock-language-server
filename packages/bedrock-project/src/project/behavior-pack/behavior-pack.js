...
const VoxelShape = __importStar(require("./voxel-shape"));
/** */
class BehaviorPack {
    type = pack_type_1.PackType.behavior_pack;
    folder;
    context;
    manifest;
    ...
    process(doc) {
        ...
        switch (Type) {
            ...
            case file_type_1.FileType.voxel_shape:
    ...
    find(predicate) {
        ...
        if ((value = this.features.find(predicate)))
            return value;
        if ((value = this.featuresRules.find(predicate)))
            return value;
        if ((value = this.functions.find(predicate)))
            return value;
        if ((value = this.items.find(predicate)))
            return value;
        if ((value = this.itemGroups.find(predicate)))
            return value;
        if ((value = this.lootTables.find(predicate)))
            return value;
        ...
        if ((value = this.trading.find(predicate)))
            return value;
        if ((value = this.voxelShapes.find(predicate)))
            return value;
        return value;
    }
    /**
    ...
    function is(value) {
        if (typeof value === 'object') {
            ...
            if (typeof temp.items !== 'object')
                return false;
            if (typeof temp.lootTables !== 'object')
                return false;
            ...
            if (typeof temp.features !== 'object')
                return false;
            if (typeof temp.featuresRules !== 'object')
                return false;
            if (typeof temp.itemGroups !== 'object')
                return false;
            if (typeof temp.biomes !== 'object')
                return false;
            if (typeof temp.recipes !== 'object')
                return false;
            if (typeof temp.voxelShapes !== 'object')
                return false;
