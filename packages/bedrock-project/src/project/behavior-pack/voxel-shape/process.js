...
const Internal = __importStar(require("../../../internal/behavior-pack/voxel-shape"));
...
function process(doc) {
    ...
    if (!Internal.VoxelShape.is(imp))
        return undefined;
    const id = imp['minecraft:voxel_shape'].description.identifier;
    return {
        id: id,
        documentation: types_1.Documentation.getDoc(doc, () => `Voxel shape: ${id}`),
