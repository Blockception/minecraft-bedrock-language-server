...
function process(doc) {
    ...
    return Object.entries(container)
        ...
        return {
            ...
            documentation: types_1.Documentation.getDoc(doc, () => `BP Animation: \`${id}\`, loop: ${anim.loop ?? false}, length: ${anim.animation_length ?? 'unknown'}`),
            events: types_1.Using.wrap(Object.values(anim.timeline ?? {})
