...
(function (VanillaPlayer) {
    VanillaPlayer.Goes = ['cape', 'humanoid.custom'];
    VanillaPlayer.Variables = __1.References.wrap(['attack_time', 'gliding_speed_value', 'hand_bob', 'player_x_rotation'], [
        'is_holding_right',
        'is_blinking',
        'last_blink_time',
        'hand_bob',
  ...
  "minecraft:client_entity": {
    ...
    VanillaPlayer.DataOBject = bc_minecraft_bedrock_shared_1.Json.parse(VanillaPlayer.Data);
...
describe('data test', () => {
    describe('VanillaPlayer', () => {
        ...
        it('Is resourpack entity', () => {
            expect(__1.Internal.ResourcePack.Entity.is(temp)).toBeTruthy();
        });
    });
});
