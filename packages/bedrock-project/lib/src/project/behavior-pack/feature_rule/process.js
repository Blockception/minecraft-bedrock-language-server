...
const Internal = __importStar(require("../../../internal/behavior-pack/feature_rule"));
...
function process(doc) {
    ...
    if (!Internal.FeatureRule.is(imp))
        return undefined;
    ...
    return {
        id: id,
        documentation: types_1.Documentation.getDoc(doc, () => `Feature Rule: ${id}`),
