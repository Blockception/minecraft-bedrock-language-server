...
const internal = __importStar(require("../../../internal/behavior-pack/item"));
...
function process(doc) {
    ...
    return {
        ...
        documentation: types_1.Documentation.getDoc(doc, () => `BP Item: ${id} ${container.description.category ? "category: " + container.description.category : ""}`),
    };
}
