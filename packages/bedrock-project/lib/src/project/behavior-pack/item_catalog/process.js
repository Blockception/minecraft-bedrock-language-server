...
const Internal = __importStar(require("../../../internal/behavior-pack/item_catalog"));
...
function process(doc) {
    ...
    if (!Internal.ItemCatalog.is(imp))
        return undefined;
    return imp["minecraft:crafting_items_catalog"].categories
        .flatMap((category) => category.groups)
        .map((entry) => {
        var _a;
        const id = (_a = entry.group_identifier) === null || _a === void 0 ? void 0 : _a.name;
        if (!id)
            return;
        return {
            id: id,
