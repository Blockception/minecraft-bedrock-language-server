...
const internal = __importStar(require("../../../internal/resource-pack/material"));
...
function process(doc) {
    ...
    return Object.entries(imp)
        ...
        return {
            ...
            documentation: types_1.Documentation.getDoc(doc, () => `Material: ${key}`),
        };
    });
}
