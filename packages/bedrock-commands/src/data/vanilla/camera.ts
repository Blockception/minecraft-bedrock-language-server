...
export const camera: CommandInfo[] = [
  ...
  },
  {
    ...
    parameters: [
      ...
      { text: "red", type: ParameterType.integer, required: true },
      { text: "green", type: ParameterType.integer, required: true },
      { text: "blue", type: ParameterType.integer, required: true },
    ],
  },
  {
    name: "camera",
