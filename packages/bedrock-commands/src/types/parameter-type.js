...
(function (ParameterType) {
    ...
    ParameterType[ParameterType["scoreComparator"] = 45] = "scoreComparator";
    /** Particle identifier */
    ParameterType[ParameterType["particle"] = 46] = "particle";
    /** Permission */
    ParameterType[ParameterType["permission"] = 47] = "permission";
    /** Permission state */
    ParameterType[ParameterType["permissionState"] = 48] = "permissionState";
    /** Recipe item */
    ParameterType[ParameterType["recipe"] = 49] = "recipe";
    /** Replace mode */
    ParameterType[ParameterType["replaceMode"] = 50] = "replaceMode";
    /** Ride Rules */
    ParameterType[ParameterType["rideRules"] = 51] = "rideRules";
    /** Ride Fill Mode */
    ParameterType[ParameterType["ridefillMode"] = 52] = "ridefillMode";
    /** Rotation Mode */
    ParameterType[ParameterType["rotation"] = 53] = "rotation";
    /** Save Mode */
    ParameterType[ParameterType["saveMode"] = 54] = "saveMode";
    /** scan Mode */
    ParameterType[ParameterType["scanMode"] = 55] = "scanMode";
    /** Selectors */
    ParameterType[ParameterType["selector"] = 56] = "selector";
    /** Slot type */
    ParameterType[ParameterType["slotType"] = 57] = "slotType";
    /** Slot ID */
    ParameterType[ParameterType["slotID"] = 58] = "slotID";
    /** Sound identifier */
    ParameterType[ParameterType["sound"] = 59] = "sound";
    /** Strings */
    ParameterType[ParameterType["string"] = 60] = "string";
    /** Structure */
    ParameterType[ParameterType["structure"] = 61] = "structure";
    /** Structure animation  mode */
    ParameterType[ParameterType["structureAnimationMode"] = 62] = "structureAnimationMode";
    /** Tag identifiers */
    ParameterType[ParameterType["tag"] = 63] = "tag";
    /** Teleport rules */
    ParameterType[ParameterType["teleportRules"] = 64] = "teleportRules";
    /** Ticking area identifiers */
    ParameterType[ParameterType["tickingarea"] = 65] = "tickingarea";
    /** Time mode */
    ParameterType[ParameterType["time"] = 66] = "time";
    /** Time in ticks */
    ParameterType[ParameterType["timeInTicks"] = 67] = "timeInTicks";
    /** Unknown */
    ParameterType[ParameterType["unknown"] = 68] = "unknown";
    /** XP */
    ParameterType[ParameterType["xp"] = 69] = "xp";
