...
describe('molang - syntax', () => {
    describe('should be able to parse and match the syntax tree generated', () => {
        test.each(dataset_valid_1.valid_syntaxes)('%#. %s', (s) => {
            const n = (0, parse_1.parseMolang)(bc_minecraft_bedrock_shared_1.OffsetWord.create(s, 0));
    ...
    describe('should throw an error', () => {
        test.each(dataset_invalid_1.invalid_syntaxes)('%#. %s', (s) => {
            expect(() => (0, parse_1.parseMolang)(bc_minecraft_bedrock_shared_1.OffsetWord.create(s, 0))).toThrow(molang_1.MolangSyntaxError);
        });
    });
});
