...
export namespace General {
  ...
  export const Queries: MolangFunction[] = [
    ...
    },
    {
      ...
      documentation:
        "TRS stands for Translate/Rotate/Scale. Takes the name of the bone as an argument. Returns the bone orientation matrix decomposed into the component translation/rotation/scale parts of the desired bone provided it exists in the queryable geometry of the mob, else this returns the identity matrix and throws a content error. The returned value is returned as a variable of type 'struct' with members '.t', '.r', and '.s', each with members '.x', '.y', and '.z'",
      parameters: [
        {
          id: 'bone',
          documentation: 'Bone name',
    ...
    },
    {
      ...
      deprecated:
        'Deprecated after 1.20.3. Please see camel.entity.json script.pre_animation for example of how to now process dash cooldown',
    },
    ...
    },
    {
      ...
      parameters: [
        { id: 'slot_name', documentation: 'equipment slot name' },
        { id: 'tag', documentation: 'tag name to check' },
      ],
      minParams: 2,
    },
    {
    ...
    },
    {
      ...
      parameters: [
        { id: 'mode', documentation: "graphics mode ('simple', 'fancy', 'deferred', 'raytraced')" },
      ],
      minParams: 1,
    },
    {
    ...
    },
    {
      ...
      parameters: [
        { id: 'slot_name', documentation: 'equipment slot name' },
        { id: 'slot_index', documentation: 'optional slot index value' },
        { id: 'item', documentation: 'item name to check' },
      ],
      minParams: 3,
    },
    ...
    },
    {
      ...
      parameters: [
        { id: 'name', documentation: 'possible entity name' },
      ],
      minParams: 1,
    },
    {
    ...
    },
    {
      ...
      parameters: [
        { id: 'mode', documentation: "input mode ('keyboard_and_mouse', 'touch', or 'gamepad')" },
      ],
      minParams: 1,
    },
    {
    ...
    },
    {
      ...
      parameters: [
        { id: 'x', documentation: 'entity-relative position on the x axis' },
        { id: 'y', documentation: 'entity-relative position on the y axis' },
        { id: 'z', documentation: 'entity-relative position on the z axis' },
        { id: 'tag', documentation: 'tag name to check' },
      ],
      minParams: 4,
    },
    ...
    // Experimental
    {
      ...
      parameters: [
        { id: 'tag', documentation: 'biome tag name to check' },
      ],
      minParams: 1,
    },
    {
      ...
      parameters: [
        { id: 'identifier', documentation: 'biome identifier to check' },
      ],
      minParams: 1,
    },
    {
