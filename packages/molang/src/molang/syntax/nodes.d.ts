...
export declare namespace UnaryOperationNode {
    ...
    const is: (data: ExpressionNode) => data is UnaryOperationNode;
}
...
export declare namespace AssignmentNode {
    ...
    const is: (data: ExpressionNode) => data is AssignmentNode;
}
...
export declare namespace LiteralNode {
    ...
    const is: (data: ExpressionNode) => data is LiteralNode;
}
...
export declare namespace StringLiteralNode {
    ...
    const is: (data: ExpressionNode) => data is StringLiteralNode;
}
...
export declare namespace ConditionalExpressionNode {
    ...
    const is: (data: ExpressionNode) => data is ConditionalExpressionNode;
}
...
export declare namespace NullishCoalescingNode {
    ...
    const is: (data: ExpressionNode) => data is NullishCoalescingNode;
}
...
export declare namespace ArrayAccessNode {
    ...
    const is: (data: ExpressionNode) => data is ArrayAccessNode;
}
...
export declare namespace FunctionCallNode {
    ...
    const is: (data: ExpressionNode) => data is FunctionCallNode;
}
...
export declare namespace VariableNode {
    ...
    const is: (data: ExpressionNode) => data is VariableNode;
}
...
export declare namespace ResourceReferenceNode {
    ...
    const is: (data: ExpressionNode) => data is ResourceReferenceNode;
}
...
export declare namespace BinaryOperationNode {
    ...
    const is: (data: ExpressionNode) => data is BinaryOperationNode;
}
...
export declare namespace ConditionalNode {
    ...
    const is: (data: ExpressionNode) => data is ConditionalNode;
}
...
export declare namespace StatementSequenceNode {
    ...
    const is: (data: ExpressionNode) => data is StatementSequenceNode;
}
/** Represents a sequence of statements */
...
export declare namespace MarkerNode {
    ...
    const is: (data: ExpressionNode) => data is MarkerNode;
}
...
export declare namespace ExpressionNode {
    ...
    function getIdentifier(node: Scoped, prefixed?: boolean): string;
