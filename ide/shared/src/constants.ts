...
export namespace Commands {
  ...
  export namespace Create {
    ...
    export namespace Behaviorpack {
      ...
      export const AnimationController: string = BPBase + 'animation_controllers';
      ...
      export const LootTable: string = BPBase + 'loot_table';
      /**The command to create all manifests*/
      ...
      export const SpawnRule: string = BPBase + 'spawn_rule';
    ...
    export namespace Resourcepack {
      ...
      /**The command to create animation controllers files */
      export const AnimationController: string = RPBase + 'animation_controllers';
      /**The command to create animations files */
      export const Animation: string = RPBase + 'animations';
      /**The command to create animations files */
      export const Attachable: string = RPBase + 'attachable';
      /**The command to create animations files */
      export const BiomesClient: string = RPBase + 'biomes_client';
      /**The command to create animations files */
      ...
      export const FlipbookTextures: string = RPBase + 'flipbook_textures';
      ...
      export const ItemTexture: string = RPBase + 'item_texture';
      /**The command to create all manifests*/
      ...
      export const MusicDefinitions: string = RPBase + 'music_definitions';
      /**The command to create the particle file */
      export const Particle: string = RPBase + 'particle';
      /**The command to create the particle file */
      export const RenderController: string = RPBase + 'render_controller';
      ...
      export const SoundDefinitions: string = RPBase + 'sound_definitions';
      /**The command to create the terrain texture file */
      export const TerrainTexture: string = RPBase + 'terrain_texture';
      /**The command to create the terrain texture list file */
      export const TextureList: string = RPBase + 'texture_list';
    }
