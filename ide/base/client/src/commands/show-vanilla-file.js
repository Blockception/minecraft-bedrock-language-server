...
function activate(context) {
    async function showVanillaFile() {
        ...
        const { source, files } = bc_minecraft_bedrock_vanilla_data_1.Vanilla.GithubFiles;
        if (files.length === 0) {
            return;
        }
    ...
    context.subscriptions.push(vscode_1.commands.registerCommand(ide_shared_1.Commands.ShowVanillaFile, showVanillaFile));
}
