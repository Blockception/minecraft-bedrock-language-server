...
function activate(context) {
    ...
    context.subscriptions.push(vscode_1.commands.registerCommand(ide_shared_1.Commands.ShowDocs, showDocs));
}
    ...
    async download(uri, filepath) {
        ...
        return vscode_1.window.withProgress(progressOptions, async (progress) => {
            ...
            try {
                ...
                const mdUrl = matches[0].replace('MicrosoftDocs/minecraft-creator/blob/', 'MicrosoftDocs/minecraft-creator/raw/');
