...
exports.createDefinitionDocGenerator = createDefinitionDocGenerator;
/**
 ...
 * ```
 */
function createDefinitionDocGenerator(definedPrefix, projectPrefix) {
    return (item) => {
        if (typeof item === 'string')
            return `${definedPrefix}: ${item}`;
