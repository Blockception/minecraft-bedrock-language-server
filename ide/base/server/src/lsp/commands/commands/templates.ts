...
export const TemplateCommands: TemplateItem[] = [
  new TemplateItem(
    BPC.AnimationController,
    BPT.animationController,
  ...
  new TemplateItem(BPC.LootTable, BPT.lootTable, 'loot_tables', '${{id.safe}}.loot.json'),
  ...
  new TemplateItem(BPC.SpawnRule, BPT.spawnRule, 'spawn_rules', '${{id.safe}}.spawn.json'),
  ...
  new TemplateItem(BPC.ItemCatalog, BPT.itemCatalog, 'item_catalog', '${{id.safe}}.item_catalog.json'),
  new TemplateItem(BPC.Feature, BPT.feature, 'features', '${{id.safe}}.feature.json'),
  new TemplateItem(BPC.FeatureRule, BPT.featureRule, 'feature_rules', '${{id.safe}}.feature_rule.json'),
  //RPS
  new TemplateItem(
    RPC.AnimationController,
    RPT.animationController,
    'animation_controllers',
    '${{id.safe}}.controller.json',
  ),
  ...
  new TemplateItem(RPC.BiomesClient, RPT.biomesClient, 'biomes_client.json'),
  new TemplateItem(RPC.Blocks, RPT.blocks, 'blocks.json'),
  new TemplateItem(RPC.BlockCulling, RPT.blockCulling, 'block_culling', '${{id.safe}}.rule.json'),
  ...
  new TemplateItem(RPC.FlipbookTextures, RPT.flipbookTextures, 'textures', 'flipbook_textures.json'),
  new TemplateItem(RPC.ItemTexture, RPT.itemTexture, 'textures', 'item_texture.json'),
  ...
  new TemplateItem(RPC.MusicDefinitions, RPT.musicDefinitions, 'sounds', 'music_definitions.json'),
  new TemplateItem(RPC.Particle, RPT.particle, 'particles', '${{id.safe}}.particle.json'),
  new TemplateItem(RPC.RenderController, RPT.renderController, 'render_controllers', '${{id.safe}}.render.json'),
  new TemplateItem(RPC.Sounds, RPT.sounds, 'sounds.json'),
  new TemplateItem(RPC.SoundDefinitions, RPT.soundDefinitions, 'sounds', 'sound_definitions.json'),
  new TemplateItem(RPC.TerrainTexture, RPT.terrainTexture, 'textures', 'terrain_texture.json'),
  //Other
