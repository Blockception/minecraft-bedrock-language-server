...
exports.getCurrentStringValue = getCurrentStringValue;
exports.getEndOfPropertyKey = getEndOfPropertyKey;
exports.getStartString = getStartString;
 ...
 * @returns
 */
function getCurrentElement(text, cursor) {
    let startIndex = -1;
    let inString = false;
 ...
 * @returns
 */
function getCurrentString(text, cursor) {
    let startIndex = -1;
 ...
 */
function getCurrentStringValue(text, property, cursor) {
...
function getEndOfPropertyKey(text, property, start) {
 ...
 * @returns
 */
function getStartString(Text, cursor) {
    for (let Index = cursor; Index > -1; Index--) {
        const c = Text.charAt(Index);
        if (c === '"') {
            if (Text.charAt(Index - 1) === '\\') {
 ...
 * @returns
 */
function isProperty(Text, startIndex) {
