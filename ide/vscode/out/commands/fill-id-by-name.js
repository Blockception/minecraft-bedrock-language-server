...
function activate(context) {
  async function FillIdByName() {
    ...
    return command.process('resource_pack/texts/en_US.lang', sources_1.GithubFiles.source);
  }
  context.subscriptions.push(vscode_1.commands.registerCommand(shared_1.Commands.FillIdByName, FillIdByName));
}
