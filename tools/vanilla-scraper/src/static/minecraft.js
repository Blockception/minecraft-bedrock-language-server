...
exports.installationFolder = installationFolder;
exports.eduInstallationFolder = eduInstallationFolder;
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
/**
 * Get Minecraft installation folder (Windows only)
 */
function installationFolder() {
 ...
 */
function eduInstallationFolder() {
